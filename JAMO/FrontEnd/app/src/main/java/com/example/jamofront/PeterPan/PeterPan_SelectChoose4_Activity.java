...
import com.example.jamofront.databinding.PeterpanSelectchoose4Binding;
...
public class PeterPan_SelectChoose4_Activity extends AppCompatActivity implements View.OnClickListener {

    private PeterpanSelectchoose4Binding binding;
    private SubmitTrTasek httpConn2 = SubmitTrTasek.getInstance();
    private int count = 0;
    private String URl = "http://3.35.123.120:5000/solved-tquestion";
    private String ProblemAnswer[] = {"ㄱ", "ㅏ", "ㅂ","ㅏ","ㅇ"};
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.peterpan_selectchoose4);
        binding = PeterpanSelectchoose4Binding.inflate(getLayoutInflater());
    ...
    private void CheckAnswer()
    {
        ...
        {
            if (count == 1) {
                sendData(Userinfo.id,"69","true", URl);
            }
            Intent intent = new Intent(getApplicationContext(), PeterPan_SelectChoose5_Activity.class);
        ...
        {
            if (count == 1) {
                sendData(Userinfo.id,"69","false", URl);
            };
