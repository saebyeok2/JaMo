...
import com.example.jamofront.databinding.PeterpanSelectchoose5Binding;
...
public class PeterPan_SelectChoose5_Activity extends AppCompatActivity implements View.OnClickListener {

    private PeterpanSelectchoose5Binding binding;
    private SubmitTrTasek httpConn2 = SubmitTrTasek.getInstance();
    private int count = 0;
    private String URl = "http://3.35.123.120:5000/solved-tquestion";
    private String ProblemAnswer[] = {"ㅎ", "ㅐ", "ㅇ","ㅅ","ㅏ"};
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.peterpan_selectchoose5);
        binding = PeterpanSelectchoose5Binding.inflate(getLayoutInflater());
    ...
    private void CheckAnswer()
    {
        ...
        {
            if (count == 1) {
                sendData(Userinfo.id,"70","true", URl);
            }
            Intent intent = new Intent(getApplicationContext(), select_peterpantype.class);
        ...
        {
            if (count == 1) {
                sendData(Userinfo.id,"70","false", URl);
            };
