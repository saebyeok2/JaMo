...
import com.example.jamofront.databinding.LittleprinceReading4Binding;
...
public class Littleprince_reading4_Acitivty extends AppCompatActivity implements View.OnClickListener {
    ...
    private LittleprinceReading4Binding binding;
    private int count = 0;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.littleprince_reading4);
        binding = LittleprinceReading4Binding.inflate(getLayoutInflater());
    ...
    public void onClick(View v) {
        switch (v.getId())
        {
            case R.id.answer1_btn:
            {
                ...
                if(count ==1)
                {
                    sendData(Userinfo.id,"39","true",URl);
                }
                Intent intent = new Intent(getApplicationContext(), Littleprince_reading5_Activity.class);
            ...
            case R.id.answer4_btn: {
                ...
                if(count==1)
                {
                    sendData(Userinfo.id,"39","false",URl);
                }
