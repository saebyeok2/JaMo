...
import com.example.jamofront.databinding.PeterpanSamefind4Binding;
...
public class PeterPan_Samefind4_Activity extends AppCompatActivity implements View.OnClickListener {
    private SubmitTrTasek httpConn2 = SubmitTrTasek.getInstance();
    private String URl = "http://3.35.123.120:5000/solved-tquestion" ;
    private PeterpanSamefind4Binding binding;
    private int count = 0;
    private String Pb  = "감옥";
    private String Pbtext [] = {"돌고래","반지","감자","시소"}; // 문제 단어들 배열 선언
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.peterpan_samefind4);
        binding = PeterpanSamefind4Binding.inflate(getLayoutInflater());
    ...
    public void onClick(View v) {
        switch (v.getId())
        {
            ...
            case R.id.answer4_btn: {
                ...
                if(count == 1)
                {
                    sendData(Userinfo.id,"59","false", URl);
                }
            ...
            case R.id.answer3_btn:
            {
                ...
                if(count == 1)
                {
                    sendData(Userinfo.id,"59","true", URl);
                }
                Intent intent = new Intent(getApplicationContext(), PeterPan_Samefind5_Activity.class);
