...
import com.example.jamofront.databinding.PeterpanNumber2Binding;
...
public class PeterPan_Number2_Activity extends AppCompatActivity implements View.OnClickListener {

    private PeterpanNumber2Binding binding;
    private SubmitTrTasek httpConn2 = SubmitTrTasek.getInstance();
    private String URl = "http://3.35.123.120:5000/solved-tquestion" ;
    private String Answertext [] = {"회사","양배추","한국어","학급"};
    private int count = 0;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.peterpan_number2);
        binding = PeterpanNumber2Binding.inflate(getLayoutInflater());
        ...
        switch(v.getId())
        {
            ...
            case R.id.answer4_btn: {
                ...
                if (count == 1) {
                    ...
                    if (count == 1) {
                        sendData(Userinfo.id,"62","false",URl);
                    }
                }
            ...
            case R.id.answer1_btn:
            {
                ...
                if (count == 1) {
                    if (count == 1) {
                        sendData(Userinfo.id,"62","true",URl);
                        // Post 하기위한 조건문 들어갈 자리
                    }
                    // Post 하기위한 조건문 들어갈 자리
                }
                //
                Intent intent = new Intent(getApplicationContext(), PeterPan_Number3_Activity.class);
