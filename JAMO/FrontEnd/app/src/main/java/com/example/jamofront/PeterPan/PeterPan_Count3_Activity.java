...
import com.example.jamofront.databinding.PeterpanCount3Binding;
...
public class PeterPan_Count3_Activity extends AppCompatActivity implements View.OnClickListener {

    private PeterpanCount3Binding binding;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.peterpan_count3);
        binding = PeterpanCount3Binding.inflate(getLayoutInflater());
        ...
        switch(v.getId())
        {
            ...
            case R.id.ct_check:
            {
                ...
                if (MyAnswer == ProblemAnswer) {
                    if(count == 1)
                    {
                        sendData(Userinfo.id,"43","true", URl);

                    }

                    Intent intent = new Intent(getApplicationContext(), PeterPan_Count4_Activity.class);
                ...
                else if (MyAnswer != ProblemAnswer)
                {
                    ...
                    if(count == 1)
                    {
                        sendData(Userinfo.id,"43","false", URl);
