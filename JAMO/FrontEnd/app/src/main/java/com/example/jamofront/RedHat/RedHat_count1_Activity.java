...
public class RedHat_count1_Activity extends AppCompatActivity implements View.OnClickListener {
    private RedhatCount1Binding binding;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.redhat_count1);
        binding = RedhatCount1Binding.inflate(getLayoutInflater());
        ...
        switch(v.getId())
        {
            ...
            case R.id.ct_check:
            {
                ...
                if (MyAnswer == ProblemAnswer) {
                    if(count == 1)
                    {
                        sendData(Userinfo.id,"81","true", URl);

                    }

                    Intent intent = new Intent(getApplicationContext(), RedHat_count2_Activity.class);
                ...
                else if (MyAnswer != ProblemAnswer)
                {
                    ...
                    if(count == 1)
                    {
                        sendData(Userinfo.id,"81","false", URl);
