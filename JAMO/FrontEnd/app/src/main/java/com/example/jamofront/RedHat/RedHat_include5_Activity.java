...
import com.example.jamofront.databinding.RedhatInclude5Binding;
...
public class RedHat_include5_Activity extends AppCompatActivity implements View.OnClickListener {
    private SubmitTrTasek httpConn2 = SubmitTrTasek.getInstance();

    private String URl = "http://3.35.123.120:5000/solved-tquestion";
    private RedhatInclude5Binding binding;
    private String ProblemText = "손가락"; //tts를 사용하기위한 문제 텍스트
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.redhat_include5);
        binding = RedhatInclude5Binding.inflate(getLayoutInflater());
    ...
    public void onClick(View v){
        ...
        switch (v.getId()) {
            case R.id.true_btn: {
                ...
                if (Trycount == 1) {
                    sendData(Userinfo.id,"90","true", URl);
                }
            ...
            case R.id.false_btn: {
                Trycount += 1;
                if (Trycount == 1) {
                    sendData(Userinfo.id ,"90","false", URl);
                }
                Intent intent = new Intent(getApplicationContext(), Select_redhoodtype.class);
