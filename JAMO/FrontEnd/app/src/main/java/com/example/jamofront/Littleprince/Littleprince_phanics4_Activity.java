...
public class Littleprince_phanics4_Activity extends AppCompatActivity {
    ...
    private String ProblemText = "어른들은 원래 모두 어린이들이였다..";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.littleprince_phanics4);
        permissionCheck();
        ...
        Check_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                sendData(Userinfo.id,"34",Answer,URl);
            ...
            runOnUiThread(new Runnable() {
                ...
                public void run() {
                    if(result.contains("true"))
                    {
                        ...
                        Intent intent = new Intent(getApplicationContext(), Littleprince_phanics5_Activity.class);
