...
import com.example.jamofront.databinding.LittleprinceNumber2Binding;
...
public class Littleprince_number2_Activity extends AppCompatActivity implements View.OnClickListener {
    private LittleprinceNumber2Binding binding;
    private SubmitTrTasek httpConn2 = SubmitTrTasek.getInstance();
    private String URl = "http://3.35.123.120:5000/solved-tquestion" ;
    private String Answertext [] = {"나무","잔디","소리","모자"};
    private int count = 0;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.littleprince_number2);
        binding = LittleprinceNumber2Binding.inflate(getLayoutInflater());
    ...
    public void onClick(View v) {
        switch(v.getId())
        {
            ...
            case R.id.answer4_btn: {
                ...
                if (count == 1) {
                    // Post 하기위한 조건문 들어갈 자리
                        sendData(Userinfo.id,"22","false",URl);
                }
            ...
            case R.id.answer2_btn:
            {
                count += 1;
                if (count == 1) {
                    sendData(Userinfo.id,"22","true",URl);
                    // Post 하기위한 조건문 들어갈 자리
                    // Post 하기위한 조건문 들어갈 자리
                }
                Intent intent = new Intent(getApplicationContext(), Littleprince_number3_Activity.class);
