...
import com.example.jamofront.databinding.PeterpanSamefind2Binding;
...
public class PeterPan_Samefind2_Activity extends AppCompatActivity implements View.OnClickListener {
    private SubmitTrTasek httpConn2 = SubmitTrTasek.getInstance();
    private String URl = "http://3.35.123.120:5000/solved-tquestion" ;
    private PeterpanSamefind2Binding binding;
    private int count = 0;
    private String Pb  = "냉장고";
    private String Pbtext [] = {"기차","냉면","달력","포크"}; // 문제 단어들 배열 선언
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.peterpan_samefind2);
        binding = PeterpanSamefind2Binding.inflate(getLayoutInflater());
    ...
    public void onClick(View v) {
        switch (v.getId())
        {
            ...
            case R.id.answer4_btn: {
                ...
                if(count == 1)
                {
                    sendData(Userinfo.id,"57","false", URl);
                }
            ...
            case R.id.answer2_btn:
            {
                ...
                if(count == 1)
                {
                    sendData(Userinfo.id,"57","true", URl);
                }
                Intent intent = new Intent(getApplicationContext(), PeterPan_Samefind3_Activity.class);
