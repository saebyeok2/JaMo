...
public class PeterPan_AnswerRate_Acitivty extends AppCompatActivity {
    private PeterpanAnswerrateBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.peterpan_answerrate);
        binding = PeterpanAnswerrateBinding.inflate(getLayoutInflater());
