...
public class RedHat_phonics1_Activity extends AppCompatActivity {
    ...
    private String ProblemText = "옛날에 모두의 사랑을 받는 귀여운 소녀가 있었어요.";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.redhat_phonics1);
        permissionCheck();
        ...
        Check_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                sendData(Userinfo.id,"111",Answer,URl);
        ...
        public void onResponse(Call call, Response response) throws IOException {
            ...
            runOnUiThread(new Runnable() {
                ...
                public void run() {
                    ...
                    {
                        //
                        Intent intent = new Intent(getApplicationContext(), RedHat_phonics2_Activity.class);
