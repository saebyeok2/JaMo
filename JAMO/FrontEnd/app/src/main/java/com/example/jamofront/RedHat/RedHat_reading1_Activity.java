...
public class RedHat_reading1_Activity extends AppCompatActivity implements View.OnClickListener{
    ...
    private RedhatReading1Binding binding;
    private int count = 0;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.redhat_reading1);
        binding = RedhatReading1Binding.inflate(getLayoutInflater());
    ...
    public void onClick(View v) {
        switch (v.getId())
        {
            ...
            case R.id.answer3_btn: {
                ...
                if(count==1)
                {
                    sendData(Userinfo.id,"116","false",URl);
                }
            ...
            case R.id.answer2_btn:
            {
                ...
                if(count ==1)
                {
                    sendData(Userinfo.id,"116","true",URl);
                }
                Intent intent = new Intent(getApplicationContext(), RedHat_reading2_Activity.class);
