...
public class Littleprince_SelectChoose1_Activity extends AppCompatActivity implements View.OnClickListener {
    private LittleprinceSelectChoose1Binding binding;
    private SubmitTrTasek httpConn2 = SubmitTrTasek.getInstance();
    private int count = 0;
    private String URl = "http://3.35.123.120:5000/solved-tquestion";
    private String ProblemAnswer[] = {"ㅂ", "ㅕ", "ㄹ"};
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.littleprince_select_choose1);
        binding = LittleprinceSelectChoose1Binding.inflate(getLayoutInflater());
    ...
    private void CheckAnswer()
    {
        ...
        {
            if (count == 1) {
                sendData(Userinfo.id,"26","true", URl);
            }
            Intent intent = new Intent(getApplicationContext(), Littleprince_SelectChoose2_Activity.class);
        ...
        {
            if (count == 1) {
                sendData(Userinfo.id,"26","false", URl);
            };
