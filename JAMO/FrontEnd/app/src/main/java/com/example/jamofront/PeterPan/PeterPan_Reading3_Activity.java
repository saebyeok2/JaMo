...
import com.example.jamofront.databinding.PeterpanReading3Binding;
...
public class PeterPan_Reading3_Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    private PeterpanReading3Binding binding;
    private int count = 0;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.peterpan_reading3);
        binding =  PeterpanReading3Binding.inflate(getLayoutInflater());
    ...
    public void onClick(View v) {
        switch (v.getId())
        {
            ...
            case R.id.answer4_btn: {
                ...
                if(count==1)
                {
                    sendData(Userinfo.id,"78","false",URl);
                }
            ...
            case R.id.answer2_btn:
            {
                ...
                if(count ==1)
                {
                    sendData(Userinfo.id,"78","true",URl);
                }
                Intent intent = new Intent(getApplicationContext(), PeterPan_Reading4_Activity.class);
