...
import com.example.jamofront.databinding.RedhatNumber3Binding;
...
public class RedHat_number3_Activity extends AppCompatActivity implements View.OnClickListener{
    private RedhatNumber3Binding binding;
    private SubmitTrTasek httpConn2 = SubmitTrTasek.getInstance();
    private String URl = "http://3.35.123.120:5000/solved-tquestion" ;
    private String Answertext [] = {"항구","직업","소방관","서점"};
    private int count = 0;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.redhat_number3);
        binding = RedhatNumber3Binding.inflate(getLayoutInflater());
        ...
        switch(v.getId())
        {
            ...
            case R.id.answer1_btn:
            {
                ...
                if (count == 1) {
                    ...
                    if (count == 1) {
                        sendData(Userinfo.id,"103","false",URl);
                    }
                }
            ...
            case R.id.answer2_btn:
            {
                ...
                if (count == 1) {
                    if (count == 1) {
                        sendData(Userinfo.id,"103","true",URl);
                        // Post 하기위한 조건문 들어갈 자리
                    }
                    // Post 하기위한 조건문 들어갈 자리
                }
                //
                Intent intent = new Intent(getApplicationContext(), RedHat_number4_Activity.class);
