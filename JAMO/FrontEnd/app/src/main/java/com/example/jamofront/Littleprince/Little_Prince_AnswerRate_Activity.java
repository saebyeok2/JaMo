...
import com.example.jamofront.databinding.LittlePrinceAnswerrateBinding;
...
public class Little_Prince_AnswerRate_Activity extends AppCompatActivity{
    private LittlePrinceAnswerrateBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = LittlePrinceAnswerrateBinding.inflate(getLayoutInflater());
