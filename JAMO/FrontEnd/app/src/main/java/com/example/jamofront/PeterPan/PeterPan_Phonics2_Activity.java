...
import com.example.jamofront.Littleprince.Littleprince_phanics2_Activity;
...
public class PeterPan_Phonics2_Activity extends AppCompatActivity {
    ...
    private String ProblemText = " 너는 아직 꿈을 이룰 충분한 시간이 있어.";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.peterpan_phonics2);
        permissionCheck();
        ...
        Check_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                sendData(Userinfo.id,"72",Answer,URl);
        ...
        public void onResponse(Call call, Response response) throws IOException {
            ...
            runOnUiThread(new Runnable() {
                ...
                public void run() {
                    ...
                    {
                        //
                        Intent intent = new Intent(getApplicationContext(), PeterPan_Phonics3_Activity.class);
