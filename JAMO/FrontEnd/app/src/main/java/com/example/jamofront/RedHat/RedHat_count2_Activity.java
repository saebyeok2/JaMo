...
public class RedHat_count2_Activity extends AppCompatActivity implements View.OnClickListener {
    private RedhatCount2Binding binding;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.redhat_count2);
        binding = RedhatCount2Binding.inflate(getLayoutInflater());
        ...
        switch(v.getId())
        {
            ...
            case R.id.ct_check:
            {
                ...
                if (MyAnswer == ProblemAnswer) {
                    if(count == 1)
                    {
                        sendData(Userinfo.id,"82","true", URl);

                    }

                    Intent intent = new Intent(getApplicationContext(), RedHat_count3_Activity.class);
                ...
                else if (MyAnswer != ProblemAnswer)
                {
                    ...
                    if(count == 1)
                    {
                        sendData(Userinfo.id,"82","false", URl);
