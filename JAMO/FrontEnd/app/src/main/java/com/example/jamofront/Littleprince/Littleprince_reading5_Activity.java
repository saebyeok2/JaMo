...
import com.example.jamofront.databinding.LittleprinceReading5Binding;
...
public class Littleprince_reading5_Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    private LittleprinceReading5Binding binding;
    private int count = 0;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.littleprince_reading5);
        binding = LittleprinceReading5Binding.inflate(getLayoutInflater());
    ...
    public void onClick(View v) {
        switch (v.getId())
        {
            ...
            case R.id.answer4_btn: {
                ...
                if(count==1)
                {
                    sendData(Userinfo.id,"40","false",URl);
                }
            ...
            case R.id.answer3_btn:
            {
                ...
                if(count ==1)
                {
                    sendData(Userinfo.id,"40","true",URl);
                }
                Intent intent = new Intent(getApplicationContext(), select_type1.class);
