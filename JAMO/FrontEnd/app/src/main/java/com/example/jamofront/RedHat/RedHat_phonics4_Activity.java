...
public class RedHat_phonics4_Activity extends AppCompatActivity {
    ...
    private String ProblemText = "빨간 모자가 숲에 갔을 때 그녀는 늑대를 만났어요.";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.redhat_phonics4);
        permissionCheck();
        ...
        Check_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                sendData(Userinfo.id,"114",Answer,URl);
        ...
        public void onResponse(Call call, Response response) throws IOException {
            ...
            runOnUiThread(new Runnable() {
                ...
                public void run() {
                    ...
                    {
                        //
                        Intent intent = new Intent(getApplicationContext(), RedHat_phonics5_Activity.class);
