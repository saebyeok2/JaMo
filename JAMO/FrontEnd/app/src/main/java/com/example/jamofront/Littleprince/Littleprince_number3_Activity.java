...
import com.example.jamofront.databinding.LittleprinceNumber3Binding;
...
public class Littleprince_number3_Activity extends AppCompatActivity implements View.OnClickListener {
    private LittleprinceNumber3Binding binding;
    private SubmitTrTasek httpConn2 = SubmitTrTasek.getInstance();
    private String URl = "http://3.35.123.120:5000/solved-tquestion" ;
    private String Answertext [] = {"연못","이슬","소금","연어"};
    private int count = 0;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.littleprince_number3);
        binding = LittleprinceNumber3Binding.inflate(getLayoutInflater());
        ...
        switch(v.getId())
        {
            case R.id.answer1_btn:
           {
                ...
                if (count == 1) {
                    ...
                    sendData(Userinfo.id,"23","true",URl);
                }
                Intent intent = new Intent(getApplicationContext(), Littleprince_number4_Activity.class);
            ...
            case R.id.answer4_btn:
            {
                ...
                if (count == 1) {
                        ...
                        sendData(Userinfo.id,"23","false",URl);
                }
                break;
            }
