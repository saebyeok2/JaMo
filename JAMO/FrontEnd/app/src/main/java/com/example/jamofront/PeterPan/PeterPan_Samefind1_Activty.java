...
public class PeterPan_Samefind1_Activty extends AppCompatActivity implements View.OnClickListener {
    private SubmitTrTasek httpConn2 = SubmitTrTasek.getInstance();
    private String URl = "http://3.35.123.120:5000/solved-tquestion" ;
    private PeterpanSamefind1Binding binding;
    private int count = 0;
    private String Pb  = "도끼";
    private String Pbtext [] = {"버스","동물원","모자","도장"}; // 문제 단어들 배열 선언
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.peterpan_samefind1);
        binding = PeterpanSamefind1Binding.inflate(getLayoutInflater());
    ...
    public void onClick(View v) {
        switch (v.getId())
        {
            ...
            case R.id.answer3_btn: {
                ...
                if(count == 1)
                {
                    sendData(Userinfo.id,"56","false", URl);
                }
            ...
            case R.id.answer4_btn:
            {
                ...
                if(count == 1)
                {
                    sendData(Userinfo.id,"56","true", URl);
                }
                Intent intent = new Intent(getApplicationContext(), PeterPan_Samefind2_Activity.class);
