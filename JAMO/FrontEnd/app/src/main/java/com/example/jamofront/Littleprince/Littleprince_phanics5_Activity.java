...
public class Littleprince_phanics5_Activity extends AppCompatActivity {
    ...
    private String ProblemText = "네가 4시에 온다면 난 3시부터 행복할거야.";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.littleprince_phanics5);
        permissionCheck();
        ...
        Check_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                sendData(Userinfo.id,"35",Answer,URl);
