...
import com.example.jamofront.databinding.LittleprinceCount5Binding;
...
public class Littleprince_count5_Activity extends AppCompatActivity implements View.OnClickListener {
    private LittleprinceCount5Binding binding;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.littleprince_count5);
        binding = LittleprinceCount5Binding.inflate(getLayoutInflater());
        ...
        switch(v.getId())
        {
            ...
            case R.id.ct_check:
            {
                ...
                if (MyAnswer == ProblemAnswer) {
                    if(count == 1)
                    {
                        sendData(Userinfo.id,"5","true", URl);
                    }
                    Intent intent = new Intent(getApplicationContext(), select_type1.class);
                ...
                else if (MyAnswer != ProblemAnswer)
                {
                    ...
                    if(count == 1)
                    {
                        sendData(Userinfo.id,"5","false", URl);
                    }
