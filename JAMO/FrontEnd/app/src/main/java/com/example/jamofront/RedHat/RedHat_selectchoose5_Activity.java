...
import com.example.jamofront.databinding.RedhatSelectchoose5Binding;
...
public class RedHat_selectchoose5_Activity extends AppCompatActivity implements View.OnClickListener {
    private RedhatSelectchoose5Binding binding;
    private SubmitTrTasek httpConn2 = SubmitTrTasek.getInstance();
    private int count = 0;
    private String URl = "http://3.35.123.120:5000/solved-tquestion";
    private String ProblemAnswer[] = {"ㅇ", "ㅏ", "ㅍ", "ㅏ", "ㅌ", "ㅡ"};
    ...
    private String ProblemText = "아파트";
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.redhat_selectchoose5);
        binding = RedhatSelectchoose5Binding.inflate(getLayoutInflater());
    ...
    private void CheckAnswer()
    {
        ...
        {
            if (count == 1) {
                sendData(Userinfo.id,"110","true", URl);
            }
            Intent intent = new Intent(getApplicationContext(), Select_redhoodtype.class);
        ...
        {
            if (count == 1) {
                sendData(Userinfo.id,"110","false", URl);
            };
