...
public class RedHat_number1_Activity extends AppCompatActivity implements View.OnClickListener{
    private RedhatNumber1Binding binding;
    private SubmitTrTasek httpConn2 = SubmitTrTasek.getInstance();
    private String URl = "http://3.35.123.120:5000/solved-tquestion" ;
    private String Answertext [] = {"개선","예상","야구","실수"};
    private int count = 0;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.redhat_number1);
        binding = RedhatNumber1Binding.inflate(getLayoutInflater());
        ...
        switch(v.getId())
        {
            ...
            case R.id.answer2_btn:
            {
                ...
                if (count == 1) {
                    ...
                    if (count == 1) {
                        sendData(Userinfo.id,"101","false",URl);
                    }
                }
            ...
            case R.id.answer3_btn:
            {
                ...
                if (count == 1) {
                    if (count == 1) {
                        sendData(Userinfo.id,"101","true",URl);
                        // Post 하기위한 조건문 들어갈 자리
                    }
                    // Post 하기위한 조건문 들어갈 자리
                }
                //
                Intent intent = new Intent(getApplicationContext(), RedHat_number2_Activity.class);
