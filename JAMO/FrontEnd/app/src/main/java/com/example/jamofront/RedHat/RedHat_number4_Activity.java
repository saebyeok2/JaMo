...
import com.example.jamofront.databinding.LittleprinceNumber1Binding;
import com.example.jamofront.databinding.RedhatNumber1Binding;
import com.example.jamofront.databinding.RedhatNumber4Binding;
...
public class RedHat_number4_Activity extends AppCompatActivity implements View.OnClickListener{
    private RedhatNumber4Binding binding;
    private SubmitTrTasek httpConn2 = SubmitTrTasek.getInstance();
    private String URl = "http://3.35.123.120:5000/solved-tquestion" ;
    private String Answertext [] = {"도끼","코스모스","목소리","신화"};
    private int count = 0;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.redhat_number4);
        binding = RedhatNumber4Binding.inflate(getLayoutInflater());
        ...
        switch(v.getId())
        {
            ...
            case R.id.answer2_btn:
            {
                ...
                if (count == 1) {
                    ...
                    if (count == 1) {
                        sendData(Userinfo.id,"104","false",URl);
                    }
                }
            ...
            case R.id.answer3_btn:
            {
                ...
                if (count == 1) {
                    if (count == 1) {
                        sendData(Userinfo.id,"104","true",URl);
                        // Post 하기위한 조건문 들어갈 자리
                    }
                    // Post 하기위한 조건문 들어갈 자리
                }
                //
                Intent intent = new Intent(getApplicationContext(), RedHat_number5_Activity.class);
