...
import com.example.jamofront.databinding.PeterpanReading4Binding;
...
public class PeterPan_Reading4_Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    private PeterpanReading4Binding binding;
    private int count = 0;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.peterpan_reading4);
        binding =  PeterpanReading4Binding.inflate(getLayoutInflater());
    ...
    public void onClick(View v) {
        switch (v.getId())
        {
            ...
            case R.id.answer4_btn: {
                ...
                if(count==1)
                {
                    sendData(Userinfo.id,"79","false",URl);
                }
            ...
            case R.id.answer3_btn:
            {
                ...
                if(count ==1)
                {
                    sendData(Userinfo.id,"79","true",URl);
                }
                Intent intent = new Intent(getApplicationContext(), PeterPan_Reading5_Activity.class);
