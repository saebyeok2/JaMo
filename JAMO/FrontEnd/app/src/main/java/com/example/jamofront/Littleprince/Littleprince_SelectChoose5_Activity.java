...
import com.example.jamofront.databinding.LittleprinceSelectChoose5Binding;
...
public class Littleprince_SelectChoose5_Activity extends AppCompatActivity implements View.OnClickListener {
    private LittleprinceSelectChoose5Binding binding;
    private SubmitTrTasek httpConn2 = SubmitTrTasek.getInstance();
    private int count = 0;
    private String URl = "http://3.35.123.120:5000/solved-tquestion";
    private String ProblemAnswer[] = {"ㅁ", "ㅏ", "ㅇ","ㅡ","ㅁ"};
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.littleprince_select_choose5);
        binding = LittleprinceSelectChoose5Binding.inflate(getLayoutInflater());
    ...
    private void CheckAnswer()
    {
        ...
        if(Arrays.equals(UserAnswer, ProblemAnswer))
        {
            ...
            showDialog("훈련이 모두 끝났습니다. 다른유형도 한번 풀어보세요!", true, intent);
        }
