...
import com.example.jamofront.databinding.RedhatSamefind1Binding;
import com.example.jamofront.databinding.RedhatSamefind3Binding;
...
public class RedHat_samefind3_Activity extends AppCompatActivity implements View.OnClickListener {
    private SubmitTrTasek httpConn2 = SubmitTrTasek.getInstance();
    private String URl = "http://3.35.123.120:5000/solved-tquestion" ;
    private RedhatSamefind3Binding binding;
    private int count = 0;
    private String Pb  = "가로등";
    private String Pbtext [] = {"가방","오징어","하늘","모자"}; // 문제 단어들 배열 선언
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.redhat_samefind3);
        binding = RedhatSamefind3Binding.inflate(getLayoutInflater());
    ...
    public void onClick(View v) {
        switch (v.getId())
        {
            case R.id.answer1_btn:
            {
                ...
                if(count == 1)
                {
                    sendData(Userinfo.id,"98","true", URl);
                }
                Intent intent = new Intent(getApplicationContext(), RedHat_samefind4_Activity.class);
            ...
            case R.id.answer2_btn:
            {
                ...
                if(count == 1)
                {
                    sendData(Userinfo.id,"98","false", URl);
                }
