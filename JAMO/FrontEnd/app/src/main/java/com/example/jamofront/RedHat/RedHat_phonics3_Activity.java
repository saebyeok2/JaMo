...
public class RedHat_phonics3_Activity extends AppCompatActivity {
    ...
    private String ProblemText = "소녀는 '빨간 모자'라고 불렸어요";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.redhat_phonics3);
        permissionCheck();
        ...
        Check_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                sendData(Userinfo.id,"113",Answer,URl);
        ...
        public void onResponse(Call call, Response response) throws IOException {
            ...
            runOnUiThread(new Runnable() {
                ...
                public void run() {
                    ...
                    {
                        //
                        Intent intent = new Intent(getApplicationContext(), RedHat_phonics4_Activity.class);
