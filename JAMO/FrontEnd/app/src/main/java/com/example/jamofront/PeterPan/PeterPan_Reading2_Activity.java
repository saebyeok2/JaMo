...
import com.example.jamofront.Littleprince.Littleprince_reading2_Activity;
import com.example.jamofront.R;
import com.example.jamofront.Task.SubmitTrTasek;
import com.example.jamofront.Userinfo;
import com.example.jamofront.databinding.PeterpanReading2Binding;
...
public class PeterPan_Reading2_Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    private PeterpanReading2Binding binding;
    private int count = 0;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.peterpan_reading2);
        binding =  PeterpanReading2Binding.inflate(getLayoutInflater());
    ...
    public void onClick(View v) {
        switch (v.getId())
        {
            ...
            case R.id.answer4_btn: {
                ...
                if(count==1)
                {
                    sendData(Userinfo.id,"77","false",URl);
                }
            ...
            case R.id.answer1_btn:
            {
                ...
                if(count ==1)
                {
                    sendData(Userinfo.id,"77","true",URl);
                }
                Intent intent = new Intent(getApplicationContext(), PeterPan_Reading3_Activity.class);
