...
public class Littleprince_phanics1_Activity extends AppCompatActivity {
    ...
    private String ProblemText = "가장 중요한 것은 눈에 보이지 않아.";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.littleprince_phanics1);
        permissionCheck();
        ...
        Check_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                sendData(Userinfo.id,"31",Answer,URl);
            ...
            runOnUiThread(new Runnable() {
                ...
                public void run() {
                    if(result.contains("true"))
                    {
                        ...
                        Intent intent = new Intent(getApplicationContext(), Littleprince_phanics2_Activity.class);
