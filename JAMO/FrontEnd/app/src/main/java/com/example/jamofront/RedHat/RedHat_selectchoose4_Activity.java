...
import com.example.jamofront.databinding.RedhatSelectchoose4Binding;
...
public class RedHat_selectchoose4_Activity extends AppCompatActivity implements View.OnClickListener {
    private RedhatSelectchoose4Binding binding;
    private SubmitTrTasek httpConn2 = SubmitTrTasek.getInstance();
    private int count = 0;
    private String URl = "http://3.35.123.120:5000/solved-tquestion";
    private String ProblemAnswer[] = {"ㅇ", "ㅕ", "ㄹ", "ㅁ", "ㅐ"};
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.redhat_selectchoose4);
        binding = RedhatSelectchoose4Binding.inflate(getLayoutInflater());
    ...
    private void CheckAnswer()
    {
        ...
        {
            if (count == 1) {
                sendData(Userinfo.id,"109","true", URl);
            }
            Intent intent = new Intent(getApplicationContext(), RedHat_selectchoose5_Activity.class);
        ...
        {
            if (count == 1) {
                sendData(Userinfo.id,"109","false", URl);
            };
