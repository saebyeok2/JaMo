...
import com.example.jamofront.databinding. PeterpanReading1Binding;
import com.example.jamofront.databinding.PeterpanReading1Binding;
...
public class PeterPan_Reading1_Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    private  PeterpanReading1Binding binding;
    private int count = 0;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.peterpan_reading1);
        binding =  PeterpanReading1Binding.inflate(getLayoutInflater());
    ...
    public void onClick(View v) {
        switch (v.getId())
        {
            ...
            case R.id.answer4_btn: {
                ...
                if(count==1)
                {
                    sendData(Userinfo.id,"76","false",URl);
                }
            ...
            case R.id.answer3_btn:
            {
                ...
                if(count ==1)
                {
                    sendData(Userinfo.id,"76","true",URl);
                }
                Intent intent = new Intent(getApplicationContext(), PeterPan_Reading2_Activity.class);
