...
import com.example.jamofront.databinding.LittleprinceSamefind2Binding;
...
public class Littleprince_Samefind2_Activity extends AppCompatActivity implements View.OnClickListener{
    ...
    private LittleprinceSamefind2Binding binding;
    ...
    private int count = 0;
    private String Pb  = "지구";
    private String Pbtext [] = {"냉장고","칫솔","지도","인형"};
    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.littleprince_samefind2);
        binding = LittleprinceSamefind2Binding.inflate(getLayoutInflater());
    ...
    public void onClick(View v) {
        switch(v.getId())
        {
            ...
            case R.id.answer4_btn: {
                ...
                if(count == 1)
                {
                    sendData(Userinfo.id,"17","false", URl);
                }
            ...
            case R.id.answer3_btn:
            {
                ...
                if(count == 1)
                {
                    sendData(Userinfo.id,"17","true", URl);
                }
                Intent intent = new Intent(getApplicationContext(), Littleprince_Samefind3_Activity.class);
