...
import com.example.jamofront.databinding.RedhatProgressBinding;
...
public class RedHat_progress extends AppCompatActivity {
    private RedhatProgressBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.redhat_progress);
        binding =  RedhatProgressBinding.inflate(getLayoutInflater());
