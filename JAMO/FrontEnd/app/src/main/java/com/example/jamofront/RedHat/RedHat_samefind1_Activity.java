...
public class RedHat_samefind1_Activity extends AppCompatActivity implements View.OnClickListener {
    private SubmitTrTasek httpConn2 = SubmitTrTasek.getInstance();
    private String URl = "http://3.35.123.120:5000/solved-tquestion" ;
    private RedhatSamefind1Binding binding;
    private int count = 0;
    private String Pb  = "토끼";
    private String Pbtext [] = {"물개","반지","시소","토성"}; // 문제 단어들 배열 선언
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.redhat_samefind1);
        binding = RedhatSamefind1Binding.inflate(getLayoutInflater());
    ...
    public void onClick(View v) {
        switch (v.getId())
        {
            case R.id.answer4_btn:
            {
                ...
                if(count == 1)
                {
                    sendData(Userinfo.id,"96","true", URl);
                }
                Intent intent = new Intent(getApplicationContext(), RedHat_samefind2_Activity.class);
            ...
            case R.id.answer2_btn:
            {
                ...
                if(count == 1)
                {
                    sendData(Userinfo.id,"96","false", URl);
                }
