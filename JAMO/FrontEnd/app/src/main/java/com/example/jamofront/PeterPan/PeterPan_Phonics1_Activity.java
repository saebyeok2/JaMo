...
public class PeterPan_Phonics1_Activity extends AppCompatActivity {
    ...
    private String ProblemText = "모든 건 믿음과 신뢰만 있으면 돼.";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.peterpan_phonics1);
        permissionCheck();
        ...
        Check_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                sendData(Userinfo.id,"71",Answer,URl);
        ...
        public void onResponse(Call call, Response response) throws IOException {
            ...
            runOnUiThread(new Runnable() {
                ...
                public void run() {
                    ...
                    {
                        //
                        Intent intent = new Intent(getApplicationContext(), PeterPan_Phonics2_Activity.class);
