...
import com.example.jamofront.databinding.LittleprinceCount2Binding;
...
public class Littleprince_count2_Activity extends AppCompatActivity implements View.OnClickListener {
    private LittleprinceCount2Binding binding;
    private SubmitTrTasek httpConn2 = SubmitTrTasek.getInstance();
    private String URl = "http://3.35.123.120:5000/solved-tquestion";
    private int count = 0;
    private String Answer = "";
    private int ProblemAnswer = 3;
    private int MyAnswer = 0;
    private int BtnNum []= new int[14];
    private String ProblemText = "소행성";
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.littleprince_count2);
        binding = LittleprinceCount2Binding.inflate(getLayoutInflater());
        ...
        switch(v.getId())
        {
            ...
            case R.id.Backbtn2: {
                if (MyAnswer > 0) {
                    if (BtnNum[MyAnswer - 1] == 1) {
                        ...
                        MyAnswer -= 1;
                        binding.tvCount.setText(""+MyAnswer);
            ...
            case R.id.ct_check:
            {
                ...
                if (MyAnswer == ProblemAnswer) {
                    if(count == 1)
                    {
                        sendData(Userinfo.id,"2","true", URl);
                    }
                    Intent intent = new Intent(getApplicationContext(), Littleprince_count3_Activity.class);
                ...
                else if (MyAnswer != ProblemAnswer)
                {
                    ...
                    if(count == 1)
                    {
                        sendData(Userinfo.id,"2","false", URl);
                    }
