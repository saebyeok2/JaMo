...
import com.example.jamofront.databinding.LittleprinceInclude3Binding;
...
public class Littleprince_include3_Activity  extends AppCompatActivity implements View.OnClickListener {
    private SubmitTrTasek httpConn2 = SubmitTrTasek.getInstance();
    private String URl ="http://3.35.123.120:5000/solved-tquestion" ;
    private LittleprinceInclude3Binding binding;
    private String ProblemText = "행성"; //tts를 사용하기위한 문제 텍스트
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.littleprince_include3);
        binding = LittleprinceInclude3Binding.inflate(getLayoutInflater());
    ...
    public void onClick(View v){
        ...
        switch (v.getId()) {
            case R.id.true_btn: {
                ...
                Trycount += 1;
                if (Trycount == 1) {
                    sendData(Userinfo.id,"8","true", URl);
                    // Post 하기위한 조건문 들어갈 자리
                }
                Intent intent = new Intent(getApplicationContext(), Littleprince_include4_Activity.class);
            ...
            case R.id.false_btn: {
                ...
                Trycount += 1;
                if (Trycount == 1) {
                    sendData(Userinfo.id,"8","false", URl);
                    // Post 하기위한 조건문 들어갈 자리
                }
