...
import com.example.jamofront.databinding.LittleprinceCount4Binding;
...
public class Littleprince_count4_Activity extends AppCompatActivity implements View.OnClickListener {
    private LittleprinceCount4Binding binding;
    private SubmitTrTasek httpConn2 = SubmitTrTasek.getInstance();
    private String URl = "http://3.35.123.120:5000/solved-tquestion";
    private int count = 0;
    private int ProblemAnswer = 1;
    private String Answer = "";
    private int MyAnswer = 0;
    private int BtnNum []= new int[14];
    private String ProblemText = "풀";
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.littleprince_count4);
        binding = LittleprinceCount4Binding.inflate(getLayoutInflater());
        ...
        switch(v.getId())
        {
            ...
            case R.id.ct_check:
            {
                ...
                if (MyAnswer == ProblemAnswer) {
                    if(count == 1)
                    {
                        sendData(Userinfo.id,"4","true", URl);
                    }
                    Intent intent = new Intent(getApplicationContext(), Littleprince_count5_Activity.class);
                ...
                else if (MyAnswer != ProblemAnswer)
                {
                    ...
                    if(count == 1)
                    {
                        sendData(Userinfo.id,"4","false", URl);
                    }
                    MyAnswer=0;
