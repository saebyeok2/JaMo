...
import com.example.jamofront.databinding.RedhatReading2Binding;
...
public class RedHat_reading2_Activity extends AppCompatActivity implements View.OnClickListener{
    ...
    private RedhatReading2Binding binding;
    private int count = 0;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.redhat_reading2);
        binding = RedhatReading2Binding.inflate(getLayoutInflater());
    ...
    public void onClick(View v) {
        switch (v.getId())
        {
            ...
            case R.id.answer4_btn: {
                ...
                if(count==1)
                {
                    sendData(Userinfo.id,"117","false",URl);
                }
            ...
            case R.id.answer3_btn:
            {
                ...
                if(count ==1)
                {
                    sendData(Userinfo.id,"117","true",URl);
                }
                Intent intent = new Intent(getApplicationContext(), RedHat_reading3_Activity.class);
