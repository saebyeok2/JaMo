...
import com.example.jamofront.databinding.LittleprinceSamefind4Binding;
...
public class Littleprince_Samefind4_Activity extends AppCompatActivity implements View.OnClickListener{
    ...
    private LittleprinceSamefind4Binding binding;
    ...
    private String Pb  = "사막";
    private String Pbtext [] = {"카메라","사슴","병아리","지우개"};
    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.littleprince_samefind4);
        binding = LittleprinceSamefind4Binding.inflate(getLayoutInflater());
    ...
    public void onClick(View v) {
        switch(v.getId())
        {
            ...
            case R.id.answer4_btn:
            {
                ...
                if(count == 1)
                {
                    sendData(Userinfo.id,"19","false", URl);
                }
            ...
            case R.id.answer2_btn:
            {
                ...
                if(count == 1)
                {
                    sendData(Userinfo.id,"19","true", URl);
                }
                Intent intent = new Intent(getApplicationContext(), Littleprince_Samefind5_Activity.class);
