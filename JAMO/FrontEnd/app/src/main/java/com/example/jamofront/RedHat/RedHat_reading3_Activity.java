...
import com.example.jamofront.databinding.RedhatReading3Binding;
...
public class RedHat_reading3_Activity extends AppCompatActivity implements View.OnClickListener{
    ...
    private RedhatReading3Binding binding;
    private int count = 0;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.redhat_reading3);
        binding = RedhatReading3Binding.inflate(getLayoutInflater());
    ...
    public void onClick(View v) {
        switch (v.getId())
        {
            ...
            case R.id.answer3_btn: {
                ...
                if(count==1)
                {
                    sendData(Userinfo.id,"118","false",URl);
                }
            ...
            case R.id.answer4_btn:
            {
                ...
                if(count ==1)
                {
                    sendData(Userinfo.id,"118","true",URl);
                }
                Intent intent = new Intent(getApplicationContext(), RedHat_reading4_Activity.class);
