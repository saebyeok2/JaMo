...
import com.example.jamofront.databinding.RedhatSamefind2Binding;
...
public class RedHat_samefind2_Activity extends AppCompatActivity implements View.OnClickListener {
    private SubmitTrTasek httpConn2 = SubmitTrTasek.getInstance();
    private String URl = "http://3.35.123.120:5000/solved-tquestion" ;
    private RedhatSamefind2Binding binding;
    private int count = 0;
    private String Pb  = "카드";
    private String Pbtext [] = {"달걀","카메라","약국","손수건"}; // 문제 단어들 배열 선언
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.redhat_samefind2);
        binding = RedhatSamefind2Binding.inflate(getLayoutInflater());
    ...
    public void onClick(View v) {
        switch (v.getId())
        {
            case R.id.answer2_btn:
            {
                ...
                if(count == 1)
                {
                    sendData(Userinfo.id,"97","true", URl);
                }
                Intent intent = new Intent(getApplicationContext(), RedHat_samefind3_Activity.class);
            ...
            case R.id.answer1_btn:
            {
                ...
                if(count == 1)
                {
                    sendData(Userinfo.id,"97","false", URl);
                }
