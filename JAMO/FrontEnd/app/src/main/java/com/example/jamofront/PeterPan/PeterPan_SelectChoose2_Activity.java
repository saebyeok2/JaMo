...
import com.example.jamofront.databinding.PeterpanSelectchoose2Binding;
...
public class PeterPan_SelectChoose2_Activity extends AppCompatActivity implements View.OnClickListener {

    private PeterpanSelectchoose2Binding binding;
    private SubmitTrTasek httpConn2 = SubmitTrTasek.getInstance();
    private int count = 0;
    private String URl = "http://3.35.123.120:5000/solved-tquestion";
    private String ProblemAnswer[] = {"ㅁ", "ㅗ", "ㅎ","ㅓ","ㅁ"};
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.peterpan_selectchoose2);
        binding = PeterpanSelectchoose2Binding.inflate(getLayoutInflater());
    ...
    private void CheckAnswer()
    {
        ...
        {
            if (count == 1) {
                sendData(Userinfo.id,"67","true", URl);
            }
            Intent intent = new Intent(getApplicationContext(), PeterPan_SelectChoose3_Activity.class);
        ...
        {
            if (count == 1) {
                sendData(Userinfo.id,"67","false", URl);
            };
