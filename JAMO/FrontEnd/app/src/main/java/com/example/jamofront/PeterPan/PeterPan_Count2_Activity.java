...
import com.example.jamofront.databinding.PeterpanCount2Binding;
...
public class PeterPan_Count2_Activity extends AppCompatActivity implements View.OnClickListener {

    private PeterpanCount2Binding binding;
    ...
    private String ProblemText = "도토리";
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.peterpan_count2);
        binding = PeterpanCount2Binding.inflate(getLayoutInflater());
        ...
        switch(v.getId())
        {
            ...
            case R.id.ct_check:
            {
                ...
                if (MyAnswer == ProblemAnswer) {
                    if(count == 1)
                    {
                        sendData(Userinfo.id,"42","true", URl);

                    }

                    Intent intent = new Intent(getApplicationContext(), PeterPan_Count3_Activity.class);
                ...
                else if (MyAnswer != ProblemAnswer)
                {
                    ...
                    if(count == 1)
                    {
                        sendData(Userinfo.id,"42","false", URl);
