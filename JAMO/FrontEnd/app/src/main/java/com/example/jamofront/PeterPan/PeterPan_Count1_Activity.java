...
import com.example.jamofront.Littleprince.Littleprince_count2_Activity;
...
import com.example.jamofront.databinding.PeterpanCount1Binding;
...
public class PeterPan_Count1_Activity extends AppCompatActivity implements View.OnClickListener {
    private PeterpanCount1Binding binding;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.peterpan_count1);
        binding = PeterpanCount1Binding.inflate(getLayoutInflater());
        ...
        switch(v.getId())
        {
            ...
            case R.id.ct_check:
            {
                ...
                if (MyAnswer == ProblemAnswer) {
                    if(count == 1)
                    {
                        sendData(Userinfo.id,"41","true", URl);

                    }

                    Intent intent = new Intent(getApplicationContext(), PeterPan_Count2_Activity.class);
                ...
                else if (MyAnswer != ProblemAnswer)
                {
                    ...
                    if(count == 1)
                    {
                        sendData(Userinfo.id,"41","false", URl);
