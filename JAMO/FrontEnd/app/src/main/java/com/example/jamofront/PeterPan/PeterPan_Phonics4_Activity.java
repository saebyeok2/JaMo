...
public class PeterPan_Phonics4_Activity extends AppCompatActivity {
    ...
    private String ProblemText = "모든 모험은 첫 걸음을 필요로 하지.";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.peterpan_phonics4);
        permissionCheck();
        ...
        Check_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                sendData(Userinfo.id,"74",Answer,URl);
        ...
        public void onResponse(Call call, Response response) throws IOException {
            ...
            runOnUiThread(new Runnable() {
                ...
                public void run() {
                    ...
                    {
                        //
                        Intent intent = new Intent(getApplicationContext(), PeterPan_Phonics5_Activity.class);
