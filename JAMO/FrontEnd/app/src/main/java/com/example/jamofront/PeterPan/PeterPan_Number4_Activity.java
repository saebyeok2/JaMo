...
import com.example.jamofront.Littleprince.Littleprince_number2_Activity;
...
import com.example.jamofront.databinding.PeterpanNumber4Binding;
...
public class PeterPan_Number4_Activity extends AppCompatActivity implements View.OnClickListener {

    private PeterpanNumber4Binding binding;
    private SubmitTrTasek httpConn2 = SubmitTrTasek.getInstance();
    private String URl = "http://3.35.123.120:5000/solved-tquestion" ;
    private String Answertext [] = {"주먹","고춧가루","호기심","악몽"};
    private int count = 0;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.peterpan_number4);
        binding = PeterpanNumber4Binding.inflate(getLayoutInflater());
        ...
        switch(v.getId())
        {
            ...
            case R.id.answer4_btn: {
                ...
                if (count == 1) {
                    ...
                    if (count == 1) {
                        sendData(Userinfo.id,"64","false",URl);
                    }
                }
            ...
            case R.id.answer3_btn:
            {
                ...
                if (count == 1) {
                    if (count == 1) {
                        sendData(Userinfo.id,"64","true",URl);
                        // Post 하기위한 조건문 들어갈 자리
                    }
                    // Post 하기위한 조건문 들어갈 자리
                }
                //
                Intent intent = new Intent(getApplicationContext(), PeterPan_Number5_Activity.class);
