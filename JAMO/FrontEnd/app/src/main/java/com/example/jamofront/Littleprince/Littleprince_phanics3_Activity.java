...
public class Littleprince_phanics3_Activity extends AppCompatActivity{
    ...
    private String ProblemText = "너는 네 장미에 대해 책임이 있어.";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.littleprince_phanics3);
        permissionCheck();
        ...
        Check_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                sendData(Userinfo.id,"33",Answer,URl);
            ...
            runOnUiThread(new Runnable() {
                ...
                public void run() {
                    if(result.contains("true"))
                    {
                        ...
                        Intent intent = new Intent(getApplicationContext(), Littleprince_phanics4_Activity.class);
