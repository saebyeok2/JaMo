...
public class RedHat_selectchoose1_Activity extends AppCompatActivity implements View.OnClickListener {
    private RedhatSelectchoose1Binding binding;
    private SubmitTrTasek httpConn2 = SubmitTrTasek.getInstance();
    private int count = 0;
    private String URl = "http://3.35.123.120:5000/solved-tquestion";
    private String ProblemAnswer[] = {"ㅅ", "ㅜ", "ㅈ", "ㅓ"};
    private String UserAnswer[] = new String[4];
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.redhat_selectchoose1);
        binding = RedhatSelectchoose1Binding.inflate(getLayoutInflater());
    ...
    public void onClick(View v) {
        ...
        switch (v.getId())
        {
            ...
            case R.id.select8_btn:
            {
                ...
                BtnNum[Answers]=8;
                inputAnswerText();
                binding.select8Btn.setVisibility(View.INVISIBLE);
                break;
            }
    ...
    private void CheckAnswer()
    {
        ...
        {
            if (count == 1) {
                sendData(Userinfo.id,"106","true", URl);
            }
            Intent intent = new Intent(getApplicationContext(), RedHat_selectchoose2_Activity.class);
        ...
        {
            if (count == 1) {
                sendData(Userinfo.id,"106","false", URl);
            };
