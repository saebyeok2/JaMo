...
import com.example.jamofront.databinding.RedhatCount5Binding;
...
public class RedHat_count5_Activity extends AppCompatActivity implements View.OnClickListener {
    private RedhatCount5Binding binding;
    ...
    private String ProblemText = "물고기";
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.redhat_count5);
        binding = RedhatCount5Binding.inflate(getLayoutInflater());
        ...
        switch(v.getId())
        {
            ...
            case R.id.ct_check:
            {
                ...
                if (MyAnswer == ProblemAnswer) {
                    if(count == 1)
                    {
                        sendData(Userinfo.id,"85","true", URl);
                ...
                else if (MyAnswer != ProblemAnswer)
                {
                    ...
                    if(count == 1)
                    {
                        sendData(Userinfo.id,"85","false", URl);
