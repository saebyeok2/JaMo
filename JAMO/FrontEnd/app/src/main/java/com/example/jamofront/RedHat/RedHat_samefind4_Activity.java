...
import com.example.jamofront.databinding.RedhatSamefind4Binding;
...
public class RedHat_samefind4_Activity extends AppCompatActivity implements View.OnClickListener {
    private SubmitTrTasek httpConn2 = SubmitTrTasek.getInstance();
    private String URl = "http://3.35.123.120:5000/solved-tquestion" ;
    private RedhatSamefind4Binding binding;
    private int count = 0;
    private String Pb  = "동굴";
    private String Pbtext [] = {"고래","미술관","동전","커피"}; // 문제 단어들 배열 선언
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.redhat_samefind4);
        binding = RedhatSamefind4Binding.inflate(getLayoutInflater());
    ...
    public void onClick(View v) {
        switch (v.getId())
        {
            case R.id.answer3_btn:
            {
                ...
                if(count == 1)
                {
                    sendData(Userinfo.id,"99","true", URl);
                }
                Intent intent = new Intent(getApplicationContext(), RedHat_samefind5_Activity.class);
            ...
            case R.id.answer2_btn:
            {
                ...
                if(count == 1)
                {
                    sendData(Userinfo.id,"99","false", URl);
                }
