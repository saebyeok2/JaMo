...
import com.example.jamofront.databinding.PeterpanNumber1Binding;
...
public class PeterPan_Number1_Activity extends AppCompatActivity implements View.OnClickListener {

    private PeterpanNumber1Binding binding;
    private SubmitTrTasek httpConn2 = SubmitTrTasek.getInstance();
    private String URl = "http://3.35.123.120:5000/solved-tquestion" ;
    private String Answertext [] = {"이웃집","담요","주스","한복"};
    private int count = 0;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.peterpan_number1);
        binding = PeterpanNumber1Binding.inflate(getLayoutInflater());
        ...
        switch(v.getId())
        {
            ...
            case R.id.answer4_btn: {
                ...
                if (count == 1) {
                    ...
                    if (count == 1) {
                        sendData(Userinfo.id,"61","false",URl);
                    }
                }
            ...
            case R.id.answer3_btn:
            {
                ...
                if (count == 1) {
                    if (count == 1) {
                        sendData(Userinfo.id,"61","true",URl);
                        // Post 하기위한 조건문 들어갈 자리
                    }
                    // Post 하기위한 조건문 들어갈 자리
                }
                //
                Intent intent = new Intent(getApplicationContext(), PeterPan_Number2_Activity.class);
