...
public class RedHat_phonics2_Activity extends AppCompatActivity {
    ...
    private String ProblemText = "할머니가 소녀에게 붉은 벨벳으로 만들어진 모자를 선물했어요.";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.redhat_phonics2);
        permissionCheck();
        ...
        Check_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                sendData(Userinfo.id,"112",Answer,URl);
        ...
        public void onResponse(Call call, Response response) throws IOException {
            ...
            runOnUiThread(new Runnable() {
                ...
                public void run() {
                    ...
                    {
                        //
                        Intent intent = new Intent(getApplicationContext(), RedHat_phonics3_Activity.class);
