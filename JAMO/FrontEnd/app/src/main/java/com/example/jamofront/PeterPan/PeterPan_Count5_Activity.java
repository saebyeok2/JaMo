...
import com.example.jamofront.databinding.PeterpanCount5Binding;
...
public class PeterPan_Count5_Activity extends AppCompatActivity implements View.OnClickListener {
    private PeterpanCount5Binding binding;
    private SubmitTrTasek httpConn2 = SubmitTrTasek.getInstance();

    private String URl = "http://3.35.123.120:5000/solved-tquestion" ;
    private String Answer = " ";
    private int count = 0;
    private int ProblemAnswer = 4;
    private int MyAnswer = 0;
    private int BtnNum []= new int[14];
    private String ProblemText = "고슴도치";
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.peterpan_count5);
        binding = PeterpanCount5Binding.inflate(getLayoutInflater());
        ...
        switch(v.getId())
        {
            ...
            case R.id.ct_check:
            {
                ...
                if (MyAnswer == ProblemAnswer) {
                    if(count == 1)
                    {
                        sendData(Userinfo.id,"45","true", URl);
                ...
                else if (MyAnswer != ProblemAnswer)
                {
                    ...
                    if(count == 1)
                    {
                        sendData(Userinfo.id,"45","false", URl);
