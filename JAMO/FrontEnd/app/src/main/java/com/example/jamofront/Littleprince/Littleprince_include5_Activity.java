...
import com.example.jamofront.databinding.LittleprinceInclude5Binding;
...
public class Littleprince_include5_Activity  extends AppCompatActivity implements View.OnClickListener {
    private SubmitTrTasek httpConn2 = SubmitTrTasek.getInstance();
    private String URl = "http://3.35.123.120:5000/solved-tquestion";
    private LittleprinceInclude5Binding binding;
    private String ProblemText = "그림자"; //tts를 사용하기위한 문제 텍스트
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.littleprince_include5);
        binding = LittleprinceInclude5Binding.inflate(getLayoutInflater());
        ...
        switch (v.getId()) {
            case R.id.true_btn: {
                ...
                if (Trycount == 1) {
                    ...
                    sendData(Userinfo.id,"10","false", URl);
                }
            ...
            case R.id.false_btn: {
                ...
                Trycount += 1;
                if (Trycount == 1) {
                    sendData(Userinfo.id,"10","true", URl);
                    // Post 하기위한 조건문 들어갈 자리
                }
                Intent intent = new Intent(getApplicationContext(), select_type1.class);
