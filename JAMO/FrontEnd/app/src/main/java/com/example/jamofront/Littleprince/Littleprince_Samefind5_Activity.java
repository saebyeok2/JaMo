...
import com.example.jamofront.databinding.LittleprinceSamefind5Binding;
...
public class Littleprince_Samefind5_Activity extends AppCompatActivity implements View.OnClickListener{
    ...
    private LittleprinceSamefind5Binding binding;
    ...
    private String Pb  = "보아뱀";
    private String Pbtext [] = {"접시","가위","버섯","보름달"};
    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.littleprince_samefind5);
        binding = LittleprinceSamefind5Binding.inflate(getLayoutInflater());
    ...
    public void onClick(View v) {
        switch(v.getId())
        {
            ...
            case R.id.answer3_btn:
            {
                ...
                if(count == 1)
                {
                    sendData(Userinfo.id,"20","false", URl);
                }
            ...
            case R.id.answer4_btn:
            {
                ...
                if(count == 1)
                {
                    sendData(Userinfo.id,"20","true", URl);
                }
                Intent intent = new Intent(getApplicationContext(), select_type1.class);
