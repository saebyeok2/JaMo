...
import com.example.jamofront.databinding.PeterpanInclude2Binding;
...
public class PeterPan_include2_Activity extends AppCompatActivity implements View.OnClickListener{
    private SubmitTrTasek httpConn2 = SubmitTrTasek.getInstance();

    private String URl = "http://3.35.123.120:5000/solved-tquestion";
    private PeterpanInclude2Binding binding;
    private String ProblemText = "수박"; //tts를 사용하기위한 문제 텍스트
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.peterpan_include2);
        binding = PeterpanInclude2Binding.inflate(getLayoutInflater());
    ...
    public void onClick(View v){
        ...
        switch (v.getId()) {
            case R.id.true_btn: {
                ...
                if (Trycount == 1) {
                    sendData(Userinfo.id,"47","true", URl);
                }
                Intent intent = new Intent(getApplicationContext(), PeterPan_include3_Activity.class);
            ...
            case R.id.false_btn: {
                Trycount += 1;
                if (Trycount == 1) {
                    sendData(Userinfo.id ,"47","false", URl);
                }
