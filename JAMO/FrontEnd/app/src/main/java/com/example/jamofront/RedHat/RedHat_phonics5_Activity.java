...
public class RedHat_phonics5_Activity extends AppCompatActivity {
    ...
    private String ProblemText = "빨간 모자는 늑대가 얼마나 나쁜 동물인지 몰랐어요.";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.redhat_phonics5);
        permissionCheck();
        ...
        Check_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                sendData(Userinfo.id,"115",Answer,URl);
