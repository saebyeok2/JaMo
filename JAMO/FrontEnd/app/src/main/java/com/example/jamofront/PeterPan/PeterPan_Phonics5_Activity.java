...
public class PeterPan_Phonics5_Activity extends AppCompatActivity {
    ...
    private String ProblemText = "산다는 것은 아주 큰 모험일거야.";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.peterpan_phonics5);
        permissionCheck();
        ...
        Check_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                sendData(Userinfo.id,"75",Answer,URl);
