...
public class Littleprince_number1_Activity extends AppCompatActivity implements View.OnClickListener{
    private LittleprinceNumber1Binding binding;
    private SubmitTrTasek httpConn2 = SubmitTrTasek.getInstance();
    private String URl = "http://3.35.123.120:5000/solved-tquestion" ;
    private String Answertext [] = {"노을","사탕","감기","나비"};
    private int count = 0;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.littleprince_number1);
        binding = LittleprinceNumber1Binding.inflate(getLayoutInflater());
        ...
        switch(v.getId())
        {
            ...
            case R.id.answer3_btn: {
                ...
                if (count == 1) {
                    ...
                    if (count == 1) {
                        sendData(Userinfo.id,"21","false",URl);
                    }
                }
            ...
            case R.id.answer4_btn:
            {
                ...
                if (count == 1) {
                    if (count == 1) {
                        sendData(Userinfo.id,"21","true",URl);
                        // Post 하기위한 조건문 들어갈 자리
                    }
                    // Post 하기위한 조건문 들어갈 자리
                }

                Intent intent = new Intent(getApplicationContext(), Littleprince_number2_Activity.class);
