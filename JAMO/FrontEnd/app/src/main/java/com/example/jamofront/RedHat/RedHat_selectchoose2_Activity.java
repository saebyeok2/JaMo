...
import com.example.jamofront.databinding.RedhatSelectchoose2Binding;
...
public class RedHat_selectchoose2_Activity extends AppCompatActivity implements View.OnClickListener {
    private RedhatSelectchoose2Binding binding;
    private SubmitTrTasek httpConn2 = SubmitTrTasek.getInstance();
    private int count = 0;
    private String URl = "http://3.35.123.120:5000/solved-tquestion";
    private String ProblemAnswer[] = {"ㅂ", "ㅣ", "ㅁ", "ㅣ", "ㄹ"};
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.redhat_selectchoose2);
        binding = RedhatSelectchoose2Binding.inflate(getLayoutInflater());
    ...
    private void CheckAnswer()
    {
        ...
        {
            if (count == 1) {
                sendData(Userinfo.id,"107","true", URl);
            }
            Intent intent = new Intent(getApplicationContext(), RedHat_selectchoose3_Activity.class);
        ...
        {
            if (count == 1) {
                sendData(Userinfo.id,"107","false", URl);
            };
