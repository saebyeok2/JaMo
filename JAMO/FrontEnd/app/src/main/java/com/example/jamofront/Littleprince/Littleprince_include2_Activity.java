...
import com.example.jamofront.databinding.LittleprinceInclude2Binding;
...
public class Littleprince_include2_Activity extends AppCompatActivity implements View.OnClickListener {
    private SubmitTrTasek httpConn2 = SubmitTrTasek.getInstance();
    private String URl ="http://3.35.123.120:5000/solved-tquestion" ;
    private LittleprinceInclude2Binding binding;
    private String ProblemText = "무지개"; //tts를 사용하기위한 문제 텍스트
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.littleprince_include2);
        binding = LittleprinceInclude2Binding.inflate(getLayoutInflater());
    ...
    public void onClick(View v){
        ...
        switch (v.getId()) {
            case R.id.true_btn: {
                ...
                Trycount += 1;
                if (Trycount == 1) {
                    sendData(Userinfo.id,"7","false", URl);
                }
            ...
            case R.id.false_btn: {
                ...
                Trycount += 1;
                if (Trycount == 1) {
                    sendData(Userinfo.id,"7","true", URl);
                }
                Intent intent = new Intent(getApplicationContext(), Littleprince_include3_Activity.class);
                showDialog("정답입니다. 다음 문제로 넘어갑니다.", true, intent);
                break;
            }
