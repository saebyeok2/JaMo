...
import com.example.jamofront.databinding.LittlePrinceProgressBinding;
...
public class Little_Prince_Progress_Activity extends AppCompatActivity  {
    private LittlePrinceProgressBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.little_prince_progress);
        binding = LittlePrinceProgressBinding.inflate(getLayoutInflater());
   ...
   private void getProgress(String url) {
        new Thread() {
            public void run() {
                httpConn.getProgress(callback,url);
    ...
    private okhttp3.Callback callback = new Callback() {
        ...
        public void onResponse(Call call, Response response) throws IOException {
            ...
            try {
                ...
                int Same_Syllable = jsonObject.getInt("same_syllable");
