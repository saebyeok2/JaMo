...
public class Littleprince_reading1_Activity extends AppCompatActivity implements View.OnClickListener{
    ...
    private LittleprinceReading1Binding binding;
    private int count = 0;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.littleprince_reading1);
        binding = LittleprinceReading1Binding.inflate(getLayoutInflater());
    ...
    public void onClick(View v) {
        switch (v.getId())
        {
            ...
            case R.id.answer3_btn: {
                ...
                if(count==1)
                {
                    sendData(Userinfo.id,"36","false",URl);
                }
            ...
            case R.id.answer4_btn:
            {
                ...
                if(count ==1) 
                {
                    sendData(Userinfo.id,"36","true",URl);
                }
                Intent intent = new Intent(getApplicationContext(), Littleprince_reading2_Activity.class);
