...
import com.example.jamofront.Littleprince.Littleprince_SelectChoose2_Activity;
...
import com.example.jamofront.databinding.PeterpanSelectchoose1Binding;
...
public class PeterPan_SelectChoose1_Activity extends AppCompatActivity implements View.OnClickListener {

    private PeterpanSelectchoose1Binding binding;
    private SubmitTrTasek httpConn2 = SubmitTrTasek.getInstance();
    private int count = 0;
    private String URl = "http://3.35.123.120:5000/solved-tquestion";
    private String ProblemAnswer[] = {"ㅂ", "ㅕ", "ㄱ"};
    private String UserAnswer[] = new String[3];
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.peterpan_selectchoose1);
        binding = PeterpanSelectchoose1Binding.inflate(getLayoutInflater());
    ...
    private void CheckAnswer()
    {
        ...
        {
            if (count == 1) {
                sendData(Userinfo.id,"66","true", URl);
            }
            Intent intent = new Intent(getApplicationContext(), PeterPan_SelectChoose2_Activity.class);
        ...
        {
            if (count == 1) {
                sendData(Userinfo.id,"66","false", URl);
            };
