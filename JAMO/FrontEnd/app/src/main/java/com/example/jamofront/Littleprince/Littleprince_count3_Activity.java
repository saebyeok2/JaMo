...
import com.example.jamofront.databinding.LittleprinceCount3Binding;
...
public class Littleprince_count3_Activity extends AppCompatActivity implements View.OnClickListener {
    private LittleprinceCount3Binding binding;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.littleprince_count3);
        binding = LittleprinceCount3Binding.inflate(getLayoutInflater());
        ...
        switch(v.getId())
        {
            ...
            case R.id.ct_check:
            {
                ...
                if (MyAnswer == ProblemAnswer) {
                    if(count == 1)
                    {
                        sendData(Userinfo.id,"3","true", URl);
                    }
                    Intent intent = new Intent(getApplicationContext(), Littleprince_count4_Activity.class);
                ...
                else if (MyAnswer != ProblemAnswer)
                {
                    ...
                    if(count == 1)
                    {
                        sendData(Userinfo.id,"3","false", URl);
                    }
                    MyAnswer=0;
