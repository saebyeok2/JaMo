...
public class Littleprince_phanics2_Activity extends AppCompatActivity {
    ...
    private String ProblemText = "나는 나 자신이고, 나 자신이 될 필요가 있다.";
    ...
    ClovaTTSTask clovaTTSTask = new ClovaTTSTask(ProblemText);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.littleprince_phanics2);
        permissionCheck();
        ...
        Check_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                sendData(Userinfo.id,"32",Answer,URl);
            ...
            runOnUiThread(new Runnable() {
                ...
                public void run() {
                    if(result.contains("true"))
                    {
                        ...
                        Intent intent = new Intent(getApplicationContext(), Littleprince_phanics3_Activity.class);
