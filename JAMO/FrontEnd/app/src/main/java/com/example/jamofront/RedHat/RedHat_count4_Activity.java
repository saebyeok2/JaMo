...
import com.example.jamofront.databinding.RedhatCount4Binding;
...
public class RedHat_count4_Activity extends AppCompatActivity implements View.OnClickListener {
    private RedhatCount4Binding binding;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.redhat_count4);
        binding = RedhatCount4Binding.inflate(getLayoutInflater());
        ...
        switch(v.getId())
        {
            ...
            case R.id.ct_check:
            {
                ...
                if (MyAnswer == ProblemAnswer) {
                    if(count == 1)
                    {
                        sendData(Userinfo.id,"84","true", URl);

                    }

                    Intent intent = new Intent(getApplicationContext(), RedHat_count5_Activity.class);
                ...
                else if (MyAnswer != ProblemAnswer)
                {
                    ...
                    if(count == 1)
                    {
                        sendData(Userinfo.id,"84","false", URl);
