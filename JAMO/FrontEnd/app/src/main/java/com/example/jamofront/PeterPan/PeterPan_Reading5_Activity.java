...
import com.example.jamofront.databinding.PeterpanReading5Binding;
...
public class PeterPan_Reading5_Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    private PeterpanReading5Binding binding;
    private int count = 0;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.peterpan_reading5);
        binding =  PeterpanReading5Binding.inflate(getLayoutInflater());
    ...
    public void onClick(View v) {
        switch (v.getId())
        {
            ...
            case R.id.answer4_btn: {
                ...
                if(count==1)
                {
                    sendData(Userinfo.id,"80","false",URl);
                }
            ...
            case R.id.answer2_btn:
            {
                ...
                if(count ==1)
                {
                    sendData(Userinfo.id,"80","true",URl);
                }
                Intent intent = new Intent(getApplicationContext(), select_peterpantype.class);
