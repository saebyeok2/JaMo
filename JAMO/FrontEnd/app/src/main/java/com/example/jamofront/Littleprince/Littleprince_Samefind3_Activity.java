...
import com.example.jamofront.databinding.LittleprinceSamefind3Binding;
...
public class Littleprince_Samefind3_Activity extends AppCompatActivity implements View.OnClickListener{
    ...
    private LittleprinceSamefind3Binding binding;
    ...
    private String Pb  = "밤하늘";
    private String Pbtext [] = {"밤송이","휴지","거울","공백"};
    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.littleprince_samefind3);
        binding = LittleprinceSamefind3Binding.inflate(getLayoutInflater());
    ...
    public void onClick(View v) {
        switch(v.getId())
        {
            case R.id.answer1_btn:
            {
                ...
                if(count == 1)
                {
                    sendData(Userinfo.id,"18","true", URl);
                }
                Intent intent = new Intent(getApplicationContext(), Littleprince_Samefind4_Activity.class);
            ...
            case R.id.answer4_btn: {
                ...
                if(count == 1)
                {
                    sendData(Userinfo.id,"18","false", URl);
                }
