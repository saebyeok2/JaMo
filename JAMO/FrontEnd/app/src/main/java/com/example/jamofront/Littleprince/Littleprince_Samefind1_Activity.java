...
public class Littleprince_Samefind1_Activity extends AppCompatActivity implements View.OnClickListener {
    private SubmitTrTasek httpConn2 = SubmitTrTasek.getInstance();
    private String URl = "http://3.35.123.120:5000/solved-tquestion" ;
    private LittleprinceSamefind1Binding binding;
    private int count = 0;
    private String Pb  = "여우";
    private String Pbtext [] = {"창문","여름","시계","침대"}; // 문제 단어들 배열 선언
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.littleprince_samefind1);
        binding = LittleprinceSamefind1Binding.inflate(getLayoutInflater());
    ...
    public void onClick(View v) {
        switch (v.getId())
        {
            ...
            case R.id.answer4_btn: {
                ...
                if(count == 1)
                {
                    sendData(Userinfo.id,"16","false", URl);
                }
            ...
            case R.id.answer2_btn:
            {
                ...
                if(count == 1)
                {
                    sendData(Userinfo.id,"16","true", URl);
                }
                Intent intent = new Intent(getApplicationContext(), Littleprince_Samefind2_Activity.class);
