...
import com.example.jamofront.databinding.LittleprinceNumber4Binding;
...
public class Littleprince_number4_Activity extends AppCompatActivity implements View.OnClickListener {
    private LittleprinceNumber4Binding binding;
    private SubmitTrTasek httpConn2 = SubmitTrTasek.getInstance();
    private String URl = "http://3.35.123.120:5000/solved-tquestion" ;
    private String Answertext [] = {"토끼","부엉이","도토리","참외"};
    private int count = 0;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.littleprince_number4);
        binding = LittleprinceNumber4Binding.inflate(getLayoutInflater());
    ...
    public void onClick(View v) {
        switch(v.getId())
        {
            ...
            case R.id.answer4_btn:
            {
                ...
                if (count == 1)
                {
                    sendData(Userinfo.id,"24","false",URl);
                }
            ...
            case R.id.answer2_btn:
            {
                count += 1;
                if (count == 1) {
                    sendData(Userinfo.id, "24", "true", URl);
                    // Post 하기위한 조건문 들어갈 자리
                }
                Intent intent = new Intent(getApplicationContext(), Littleprince_number5_Activity.class);
