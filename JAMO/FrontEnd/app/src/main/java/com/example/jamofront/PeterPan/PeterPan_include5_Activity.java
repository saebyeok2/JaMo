...
import com.example.jamofront.databinding.PeterpanInclude5Binding;
...
public class PeterPan_include5_Activity extends AppCompatActivity implements View.OnClickListener{
    private SubmitTrTasek httpConn2 = SubmitTrTasek.getInstance();

    private String URl = "http://3.35.123.120:5000/solved-tquestion";
    private PeterpanInclude5Binding binding;
    private String ProblemText = "사다리"; //tts를 사용하기위한 문제 텍스트
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.peterpan_include5);
        binding = PeterpanInclude5Binding.inflate(getLayoutInflater());
    ...
    public void onClick(View v){
        ...
        switch (v.getId()) {
            case R.id.false_btn: {
                ...
                if (Trycount == 1) {
                    sendData(Userinfo.id,"50","true", URl);
                }
                Intent intent = new Intent(getApplicationContext(), select_peterpantype.class);
            ...
            case R.id.true_btn: {
                Trycount += 1;
                if (Trycount == 1) {
                    sendData(Userinfo.id ,"50","false", URl);
                }
