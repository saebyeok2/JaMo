...
public class Littleprince_count1_Activity extends AppCompatActivity implements View.OnClickListener {
    private LittleprinceCount1Binding binding;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.littleprince_count1);
        binding = LittleprinceCount1Binding.inflate(getLayoutInflater());
        ...
        switch(v.getId())
        {
            ...
            case R.id.ct_check:
            {
                ...
                if (MyAnswer == ProblemAnswer) {
                    if(count == 1)
                    {
                        sendData(Userinfo.id,"1","true", URl);

                    }

                    Intent intent = new Intent(getApplicationContext(), Littleprince_count2_Activity.class);
                ...
                else if (MyAnswer != ProblemAnswer)
                {
                    ...
                    if(count == 1)
                    {
                        sendData(Userinfo.id,"1","false", URl);
