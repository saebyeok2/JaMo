...
import com.example.jamofront.databinding.LittleprinceReading3Binding;
...
public class Littleprince_reading3_Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    private LittleprinceReading3Binding binding;
    private int count = 0;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.littleprince_reading3);
        binding = LittleprinceReading3Binding.inflate(getLayoutInflater());
    ...
    public void onClick(View v) {
        switch (v.getId())
        {
            ...
            case R.id.answer4_btn: {
                ...
                if(count==1)
                {
                    sendData(Userinfo.id,"38","false",URl);
                }
            ...
            case R.id.answer2_btn:
            {
                ...
                if(count ==1)
                {
                    sendData(Userinfo.id,"38","true",URl);
                }
                Intent intent = new Intent(getApplicationContext(), Littleprince_reading4_Acitivty.class);
