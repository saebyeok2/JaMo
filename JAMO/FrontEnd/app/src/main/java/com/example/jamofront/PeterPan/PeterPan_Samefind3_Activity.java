...
import com.example.jamofront.databinding.PeterpanSamefind3Binding;
...
public class PeterPan_Samefind3_Activity extends AppCompatActivity implements View.OnClickListener {
    private SubmitTrTasek httpConn2 = SubmitTrTasek.getInstance();
    private String URl = "http://3.35.123.120:5000/solved-tquestion" ;
    private PeterpanSamefind3Binding binding;
    private int count = 0;
    private String Pb  = "가위";
    private String Pbtext [] = {"가지","문어","교회","선장"}; // 문제 단어들 배열 선언
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.peterpan_samefind3);
        binding = PeterpanSamefind3Binding.inflate(getLayoutInflater());
    ...
    public void onClick(View v) {
        switch (v.getId())
        {
            ...
            case R.id.answer4_btn: {
                ...
                if(count == 1)
                {
                    sendData(Userinfo.id,"58","false", URl);
                }
            ...
            case R.id.answer1_btn:
            {
                ...
                if(count == 1)
                {
                    sendData(Userinfo.id,"58","true", URl);
                }
                Intent intent = new Intent(getApplicationContext(), PeterPan_Samefind4_Activity.class);
