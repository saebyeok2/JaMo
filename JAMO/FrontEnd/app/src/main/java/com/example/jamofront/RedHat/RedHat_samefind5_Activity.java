...
import com.example.jamofront.databinding.RedhatSamefind5Binding;
...
public class RedHat_samefind5_Activity extends AppCompatActivity implements View.OnClickListener {
    private SubmitTrTasek httpConn2 = SubmitTrTasek.getInstance();
    private String URl = "http://3.35.123.120:5000/solved-tquestion" ;
    private RedhatSamefind5Binding binding;
    private int count = 0;
    private String Pb  = "바구니";
    private String Pbtext [] = {"폭포","접시","바나나","감자"}; // 문제 단어들 배열 선언
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.redhat_samefind5);
        binding = RedhatSamefind5Binding.inflate(getLayoutInflater());
    ...
    public void onClick(View v) {
        switch (v.getId())
        {
            case R.id.answer3_btn:
            {
                ...
                if(count == 1)
                {
                    sendData(Userinfo.id,"100","true", URl);
                }
                Intent intent = new Intent(getApplicationContext(), Select_redhoodtype.class);
            ...
            case R.id.answer2_btn:
            {
                ...
                if(count == 1)
                {
                    sendData(Userinfo.id,"100","false", URl);
                }
