...
public class Littleprince_include1_Activity extends AppCompatActivity implements View.OnClickListener {
    private SubmitTrTasek httpConn2 = SubmitTrTasek.getInstance();

    private String URl = "http://3.35.123.120:5000/solved-tquestion";
    private LittleprinceInclude1Binding binding;
    private String ProblemText = "비행기"; //tts를 사용하기위한 문제 텍스트
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.littleprince_include1);
        binding = LittleprinceInclude1Binding.inflate(getLayoutInflater());
        ...
        public void onClick(View v){
            ...
            switch (v.getId()) {
                case R.id.true_btn: {
                    ...
                    if (Trycount == 1) {
                            sendData(Userinfo.id,"6","true", URl);
                    }
                    Intent intent = new Intent(getApplicationContext(), Littleprince_include2_Activity.class);
                ...
                case R.id.false_btn: {
                    Trycount += 1;
                    if (Trycount == 1) {
                        sendData(Userinfo.id ,"6","false", URl);
                    }
