...
import com.example.jamofront.databinding.PeterpanSelectchoose3Binding;
...
public class PeterPan_SelectChoose3_Activity extends AppCompatActivity implements View.OnClickListener {

    private PeterpanSelectchoose3Binding binding;
    private SubmitTrTasek httpConn2 = SubmitTrTasek.getInstance();
    private int count = 0;
    private String URl = "http://3.35.123.120:5000/solved-tquestion";
    private String ProblemAnswer[] = {"ㅅ", "ㅗ", "ㄱ","ㅡ","ㅁ"};
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.peterpan_selectchoose3);
        binding = PeterpanSelectchoose3Binding.inflate(getLayoutInflater());
    ...
    private void CheckAnswer()
    {
        ...
        {
            if (count == 1) {
                sendData(Userinfo.id,"68","true", URl);
            }
            Intent intent = new Intent(getApplicationContext(), PeterPan_SelectChoose4_Activity.class);
        ...
        {
            if (count == 1) {
                sendData(Userinfo.id,"68","false", URl);
            };
