...
import com.example.jamofront.databinding.RedhatReading4Binding;
...
public class RedHat_reading4_Activity extends AppCompatActivity implements View.OnClickListener{
    ...
    private RedhatReading4Binding binding;
    private int count = 0;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.redhat_reading4);
        binding = RedhatReading4Binding.inflate(getLayoutInflater());
    ...
    public void onClick(View v) {
        switch (v.getId())
        {
            ...
            case R.id.answer3_btn: {
                ...
                if(count==1)
                {
                    sendData(Userinfo.id,"119","false",URl);
                }
            ...
            case R.id.answer1_btn:
            {
                ...
                if(count ==1)
                {
                    sendData(Userinfo.id,"119","true",URl);
                }
                Intent intent = new Intent(getApplicationContext(), RedHat_reading5_Activity.class);
